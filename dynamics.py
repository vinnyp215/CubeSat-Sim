...
def dynamics(state):
    ...
    Args:
        state (np.array): Current state vector [t, x, y, z, vx, vy, vz, q0, q1, q2, q3, wx, wy, wz].
    ...
    q = state[7:10]   # Attitude quaternion [q0, q1, q2, q3]
    w = state[11:13]  # Angular velocity [wx, wy, wz]
    ...
    state_derivative[0] = t
    state_derivative[1:3] = drdt    # dr/dt = v
    state_derivative[4:6] = dvdt    # dv/dt = a
    state_derivative[7:10] = dqdt   # dq/dt
    state_derivative[11:13] = dwdt  # dω/dt
