...
class Power:
  """
  Represents the Power subsystem for a spacecraft.
  ...
  Attributes:
    ...
    current_charge (float): Current charge of the battery in Watt-hours.
  ...
  def __init__(self, battery_capacity, solar_panel_area, solar_panel_efficiency):
    ...
    self.current_charge = battery_capacity * 0.5  # Start at 50% charge
